...
export default function HeroSection() {
  return (
    <section className="w-full relative pt-12 md:pt-16 pb-16 md:pb-24 px-6 sm:px-10 lg:px-16 xl:px-24 overflow-hidden flex flex-col items-center justify-center text-center">
      ...
      <div className="w-full max-w-[1500px] mx-auto relative z-10 flex flex-col items-center justify-center text-center">
        ...
        {/* Centered Top Tag Pill with clean mt-5 (20px) margin */}
        <div className="mt-5 mb-10 flex justify-center w-full">
        ...
        {/* Hero Headline with generous spacing to subtitle */}
